...
MODULE_DESCRIPTION("A simple gpio driver for setting led and reading a button");
...
static int __init ModuleInit(void) {
  ...
  if(gpio_request(4, "gpio-4")) {
    printk("Can not allocated GPIO 4!\n");
    goto AddError;
  }
  ...
  if(gpio_request(17, "gpio-17")) {
    printk("Can not allocated GPIO 17!\n");
    goto AddError;
  }
